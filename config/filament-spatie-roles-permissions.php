...
return [
    ...
    'navigation_section_group' => 'Roles y Permisos', // Default uses language constant
     ...
     */
    'icons' => [
        'role_navigation' => 'heroicon-o-user-group',
        'permission_navigation' => 'heroicon-o-lock-open',
    ],
