...
class CulturaController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($response->getStatusCode() >= 400) {
            ...
            return redirect('admin/cultura-viewer')->with('success', 'Datos actualizados correctamente');
        } catch (\Exception $e) {
...
public function delete($id)
{
    ...
    try {
        $response = $client->delete("https://backend-culturas.elalto.gob.bo/api/culturas/$id", [
            'headers' => [
                'Authorization' => 'Bearer ' . '',
                'Accept' => 'application/json',
            ],
        ...
        if ($response->getStatusCode() == 204) {
            return redirect('admin/cultura-viewer')->with('success', 'Contenido eliminado correctamente');
        } else {
