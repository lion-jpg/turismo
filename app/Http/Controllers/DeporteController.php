    ...
    public function post(Request $request)
    {
        ...
        try {
            ...
            if (isset($uploadedFile[0]['id'])) {
                ...
                $data['foto_dep'] = $uploadedFile[0]['id'];  // Cambiado para usar el ID del archivo
            } else {
...
public function delete($id)
{
    ...
    try {
        $response = $client->delete("https://backend-culturas.elalto.gob.bo/api/deportes/$id", [
            'headers' => [
                'Authorization' => 'Bearer ' . '',
                'Accept' => 'application/json',
            ],
        ...
        if ($response->getStatusCode() == 204) {
            return redirect('admin/deporte-viewer')->with('success', 'Contenido eliminado correctamente');
        } else {
